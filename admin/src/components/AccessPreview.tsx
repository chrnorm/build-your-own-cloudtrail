...
export const AccessPreview: React.FC<Props> = ({
  request,
  cedarPolicyText,
}) => {
  const { data } = useQuery(previewAuthorization, {
    request: request,
    cedarPolicyText: cedarPolicyText,
    useCustomPolicyText: cedarPolicyText !== undefined,
  });
          ...
          <Table size="md">
            <Tbody>
              ...
              <Tr>
                ...
                <Td px={0} py={2}>
                  <Text>{formatEID(data?.evaluation?.request?.resource)}</Text>
                </Td>
              </Tr>
              <Tr>
                <Td px={0} py={2} w="200px">
              ...
              <Tr>
                ...
                <Td px={0} py={2}>
                  <Text
                    ...
                    // onClick={onCopy}
                  >
                    {formatDurationMillis(data?.evaluation?.evaluationDuration)}
                  </Text>
                </Td>
              </Tr>
            </Tbody>
          ...
          <AccordionItem>
            <AccordionButton>
              <Flex
                ...
                w="100%"
              >
                <Heading fontWeight={"medium"} size="md" textColor="foreground">
                  Principal
                </Heading>
                <AccordionIcon />
              </Flex>
